...
public class db_con {
    ...
    private static void donorMenu(Connection conn, Scanner scanner) {
        boolean running = true;
        while (running) {
            try {
                System.out.println("\n--- donor ---");
    ...
    private static void donationMenu(Connection conn, Scanner scanner) {
        boolean running = true;
        while (running) {
            try {
                System.out.println("\n--- donation ---");
    ...
    private static void charityMenu(Connection conn, Scanner scanner) {
        boolean running = true;
        while (running) {
            try {
                System.out.println("\n--- charity ---");
